...
namespace Proxy\__CG__\Document\Attribute;
 ...
 */
class Type extends \Document\Attribute\Type implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    public function addAttribute(\Document\Attribute\Attribute $attribute)
    {
        $this->__load();
    ...
    {
        $this->__load();
        return parent::setAttribute($attributes);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'attributes');
    }
