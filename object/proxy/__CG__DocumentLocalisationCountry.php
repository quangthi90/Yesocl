 ...
 */
class country extends \Document\Localisation\country implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    public function addCitie(\Document\Localisation\City $citie)
    {
        $this->__load();
        return parent::addCitie($citie);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'status', 'cities');
    }
