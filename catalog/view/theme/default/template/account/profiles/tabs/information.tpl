			...
			<div class="row-fluid profile-form hidden" data-url="{{ path('ProfileEditInfo') }}">
				...
				<div class="profiles-tabs-main-body">
					<div class="basic-profiles-form" 
						...
						<div class="row-fluid profile-content-set">
							...
							<div class="span9">
								<div class="row-fluid">
									...
									{% endfor %}
									<a class="btn btn-success btn-add emails-btn-add " href="#" data-index="{{ emails|length }}">
						...
						<div class="row-fluid profile-content-set">
							...
							<div class="span9">
								<div class="row-fluid">
									...
									{% endfor %}
									<a class="btn btn-success btn-add phones-btn-add" href="#" data-index="{{ phones|length }}">
						...
						<div class="row-fluid">
							<div class="span2 offset1">Living</div>
							<div class="span9 control-group" data-autocomplete="{{ link_autocomplete_location }}">
						...
						<div class="row-fluid">
							<div class="span2 offset1">Industry</div>
							<div class="span9 control-group" data-autocomplete="{{ link_autocomplete_industry }}">
