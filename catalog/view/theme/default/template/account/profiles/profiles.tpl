...
<script id="profiles-form" type="text/x-jquery-tmpl">
	<div class="basic-profiles-form" data-url="${ url }" data-username="${ username }" data-firstname="${ firstname }" data-lastname="${ lastname }" data-fullname="${ fullname }" data-emails="${ emails_js }" data-phones="${ phones_js }" data-sex="${ sex }" data-sext="${ sext }" data-birthday="${ birthday }" data-birthdayt="${ birthdayt }" data-address="${ address }" data-location="${ location }" data-cityid="${ cityid }" data-industry="${ industry }" data-industryid="${ industryid }">
		<div class="row-fluid">
			<div class="span2 offset1">Username</div>
			<div class="span9 control-group" data-url="{{ link_validate_username }}"><input class="span5" type="text" placeholder="Input Text" name="username" value="${ username }" required="required" /></div>
		</div>
		<div class="row-fluid">
			<div class="span2 offset1">Fullname</div>
			<div class="span9"><span class="control-group" data-url="{{ link_validate_firstname }}"><input class="span3" type="text" placeholder="Input Text" name="firstname" value="${ firstname }" required="required" /></span> <span class="control-group" data-url="{{ link_validate_lastname }}"><input class="span2" type="text" placeholder="Input Text" name="lastname" value="${ lastname }" required="required" /></span></div>
		</div>
		...
		<div class="row-fluid profile-content-set">
			...
			<div class="span9">
				<div class="row-fluid">
					...
					{{ phone_loop }}
					<div class="phones-form control-group" data-id="${ $value.id }" data-type="${ $value.type }" data-url="{{ link_validate_phone }}"><input class="span5" type="text" placeholder="Input Text" name="phones[${ $index }][phone]" value="${ $value.phone }" required="required" /> <select class="span3" name="phones[${ $index }][type]">{% for phonetype in phone_types %}<option value="{{ phonetype.code }}">{{ phonetype.text }}</option>{% endfor %}</select> <a class="btn btn-danger btn-remove phones-btn-remove" href="#"><i class="icon-trash"></i></a></div>
					{{ phone_loop_end }}
		...
		<div class="row-fluid">
			<div class="span2 offset1">Address</div>
			<div class="span9 control-group" data-url="{{ link_validate_address }}"><input class="span5" type="text" placeholder="Input Text" name="address" value="${ address }" required="required" /></div>
		</div>
		<div class="row-fluid">
			<div class="span2 offset1">Living</div>
		...
		<div class="row-fluid">
			<div class="span2 offset1">Industry</div>
			<div class="span9 control-group" data-url="{{ link_validate_industry }}" data-autocomplete="{{ link_autocomplete_industry }}"><input class="span5" type="text" placeholder="Input Text" name="industry" value="${ industry }" /><input type="hidden" name="industryid" value="${ industryid }" /></div>
		</div>
	</div>
</script>
