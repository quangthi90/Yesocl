...
{% use '@template/default/template/account/profiles/tabs/step1.tpl' %}
{% use '@template/default/template/account/profiles/tabs/step2.tpl' %}
{% use '@template/default/template/account/profiles/tabs/step3.tpl' %}
{% use '@template/default/template/account/profiles/tabs/step4.tpl' %}
{% use '@template/default/template/account/profiles/tabs/step5.tpl' %}
...
{{ block('profiles_tabs_step1_javascript') }}
{{ block('profiles_tabs_step2_javascript') }}
{{ block('profiles_tabs_step3_javascript') }}
{{ block('profiles_tabs_step4_javascript') }}
