	...
	<div class="span10 register-box-step">
		...
		<div class="row-fluid">
			<div class="register-table span10 offset1">
				<div class="row-fluid register-table-heading">
					<div class="pull-left">
						<lable>
							<input type="checkbox" class="register-slect-all" /> Select All
						</label>
					</div>
				</div>
		...
		<div class="row-fluid space-top-20px">
			<div class="span11 offset1">
				...
				or
				<a href="#myCarousel" data-slide="next">Skip this step</a>
			</div>
		</div>
	</div>
...
jQuery(document).ready(function (){
	$('.register-table').on('click', '.register-slect-all', function(){
