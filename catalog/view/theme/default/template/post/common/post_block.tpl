	...
	<div class="post">
		...
		<div class="row-fluid post_footer">
			<div class="span10 post_action">
				...
				<a href="#" class="open-comment" data-url="{{ post.href_status }}" data-comment-count="{{ post.comment_count }}" data-post-id="{{ post.id }}" data-post-type="{{ post.type }}"><i class="icon-comments medium-icon"></i> Comment ({{ post.comment_count }})</a>
			</div>
			<div class="span2">
