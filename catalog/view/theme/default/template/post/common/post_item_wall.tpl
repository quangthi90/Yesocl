{% block post_common_post_item_wall %}
	...
	{% endif %}
	<div class="feed post post_status post-item js-post-item" data-url="{{ path('PostLike', {post_slug: post.slug, post_type: post_type}) }}" data-is-liked="{{ post.isUserLiked }}" data-post-type="{{ post_type }}" data-post-slug="{{ post.slug }}">
