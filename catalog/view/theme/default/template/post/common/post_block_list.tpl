                            ...
                            <div class="post_overlay_wrapper">
                                ...
                                <div class="post_action">
                                    <div class="action_tool">
                                        ...
                                        <a href="#" title="Comment ({{ post.comment_count }})" class="open-comment" data-url="{{ path('CommentList', {post_slug: post.slug, post_type: post.type}) }}" data-comment-count="{{ post.comment_count }}" data-comment-url="{{ path('CommentAdd', {post_slug: post.slug, post_type: post.type}) }}" >
                                            <i class="icon-comments medium-icon"></i>
                                        </a>
