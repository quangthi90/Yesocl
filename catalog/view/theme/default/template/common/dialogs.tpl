                                        ...
                                        <ul class="list-unstyled clearfix user-list" data-bind="foreach: members">
                                            <li class="box-shadow-light pull-left bg-white user-item">
                                                <div class="media innerAll">
                                                    ...
                                                    <a data-bind="click: $parent.removeMember, visible: $parent.canRemove() && $data.id != $parent.currentUserId" class="btn btn-default btn-sm border-none remove"><i class="fa fa-trash-o"></i></a>
                                                </div>
                                            </li>
                                        </ul>
                                        <!-- /ko -->
