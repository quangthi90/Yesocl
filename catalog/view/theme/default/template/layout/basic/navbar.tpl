  ...
  <div class="navbar hidden-print navbar-default box main" role="navigation">
      ...
      <ul class="notifications pull-left hidden-xs">
          <li class="dropdown notif">
              <a class="dropdown-toggle" data-toggle="dropdown"><i class="notif-block fa fa-bell-o"></i><span class="fa fa-star"></span></a>
          ...
          <li class="dropdown notif">
              <a class="dropdown-toggle" data-toggle="dropdown"><i class="notif-block fa fa-envelope-o"></i><span class="fa fa-star"></span></a>
              <ul class="dropdown-menu chat media-list">
                  <li class="media">
                      <a class="pull-left" href="#"><img class="media-object thumb" src="{{ asset_img('no_user_avatar.png') }}" alt="50x50" width="50"/></a>
                      <div class="media-body">
          ...
          <li class="dropdown notif">
              <a class="dropdown-toggle" data-toggle="dropdown"><i class="notif-block fa fa-user"></i><span class="fa fa-star hidden"></span></a>
              <ul class="dropdown-menu chat media-list">
                  <li class="media">
                      <a class="pull-left" href="#"><img class="media-object thumb" src="{{ asset_img('no_user_avatar.png') }}" alt="50x50" width="50"/></a>
                      <div class="media-body">
