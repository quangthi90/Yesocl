...
<html>
	<head>		
		...
		<link href="{{ asset_css_old('libs/bootstrap.css') }}" rel="stylesheet" media="screen" />
		<link href="{{ asset_css_old('libs/bootstrap-responsive.min.css') }}" rel="stylesheet" media="screen" />
		<link href="{{ asset_css_old('libs/uniform.default.css') }}" rel="stylesheet" media="screen" />
		<link href="{{ asset_css_old('libs/fortAwesome/css/font-awesome.css') }}" rel="stylesheet" media="screen" />
		<link href="{{ asset_css_old('welcome.css') }}" rel="stylesheet" media="screen" /> 
		{% block stylesheet %}
		{% endblock %}
	</head>
	<body>	
