...
{% block account_common_profile_column %}
    <div class="free-block fl" id="wall-user-info-column" style="width: 180px; opacity: 0;" data-bind="with: userInfoColumnModel">
        <div class="free-block-content">
            <div class="user_info_overview">
                ...
                <span class="user_info_name" data-bind="text: wallUser.username"></span>
                <!-- ko if: isCurrentUser == false -->
                <div class="user_relationship">
                    <!-- ko if: isLogined && wallUser.friendStatus() == 2 -->
                    ...
                    <!-- /ko -->
                    <!-- ko if: isLogined && wallUser.friendStatus() == 3 -->
                    <div class="dropdown friend-group">
                    ...
                    <!-- /ko -->
                    <!-- ko if: isLogined && wallUser.friendStatus() == 4 -->
