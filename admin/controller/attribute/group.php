<?php 
class ControllerAttributeGroup extends Controller {
	private $error = array( );
	private $limit = 10;
	private $route = 'attribute/group';
	...
	public function index(){
		...
		$this->load->language( 'attribute/group' );
	...
	private function getList( ){
		...
		$group_total = $this->model_attribute_group->getTotalGroups();
		...
		$this->template = 'attribute/group_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm(){
		...
		$this->template = 'attribute/group_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
