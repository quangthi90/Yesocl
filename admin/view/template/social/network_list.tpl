      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td><input name="id[]" type="checkbox" value="<?php echo $network['id']; ?>"/></td>
              <td><?php echo $network['name']; ?></td>
              <td><?php echo ( $network['status'] ) ? $text_enable : $text_disable; ?></td>
              <td class="right"><?php foreach ( $network['action'] as $action ) { ?>
