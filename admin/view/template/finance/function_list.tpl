...
<script type="text/javascript"><!--
  function filter() {
    url = 'index.php?route=finance/function&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
  ...
  source: function(request, response) {
    $.ajax({
      url: 'index.php?route=finance/function/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
      dataType: 'json',
