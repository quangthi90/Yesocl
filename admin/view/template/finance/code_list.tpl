      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td><input name="id[]" type="checkbox" value="<?php echo $code['id']; ?>"/></td>
              <td><?php echo $code['code']; ?></td>
              <td><?php echo $code['finance']; ?></td>
              <td><?php echo $code['status']; ?></td>
              <td class="right"><?php foreach ( $code['action'] as $action ) { ?>
