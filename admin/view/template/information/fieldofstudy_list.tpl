    ...
    <div class="content">
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            <?php if ($fieldsofstudy) { ?>
            <?php foreach ($fieldsofstudy as $fieldofstudy) { ?>
            <tr>
              <td><input name="id[]" type="checkbox" value="<?php echo $fieldofstudy['id']; ?>"/></td>
              <td><?php echo $fieldofstudy['name']; ?></td>
              <td class="right"><?php foreach ($fieldofstudy['action'] as $action) { ?>
