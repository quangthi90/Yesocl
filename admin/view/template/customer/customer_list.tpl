...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <span><img src="view/image/customer.png" alt="" /> <?php echo $heading_title; ?></span>
      <div class="buttons">
      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td><input name="id[]" type="checkbox" value="<?php echo $customer['id']; ?>"/></td>
              <td><?php echo $customer['name']; ?></td>
              <td><?php echo ($customer['status']) ? $text_enabled : $text_disabled; ?></td>
