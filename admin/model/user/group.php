...
class ModelUserGroup extends Doctrine {
	...
	public function getGroup( $group_id ) {
		return $this->dm->getRepository( 'Document\User\Group' )->find( $group_id );
	}
	...
	public function getGroups( $data = array() ) {
		...
		return $this->dm->getRepository( 'Document\User\Group' )->findAll()->limit( $data['limit'] )->skip( $data['start'] );
	}
	...
	public function getTotalGroups() {
		$groups = $this->dm->getRepository( 'Document\User\Group' )->findAll();
