...
$_['whatsnew']['option']['user'] = 'user';
$_['whatsnew']['option_title']['all'] = gettext('All posts');
$_['whatsnew']['option_title']['stock'] = gettext('Stock posts');
$_['whatsnew']['option_title']['branch'] = gettext('Branch posts');
$_['whatsnew']['option_title']['user'] = gettext('Friend, Friend\'s friend posts');
$_['whatsnew']['option_function']['all'] = 'getAllPosts';
